...
def test_init():
    ...
    ## Método hint()
    assert(len(h.hint_list('menta', '00101')) == 191)
    assert(len(h.hint_list('nariz', '12100')) == 1)
    assert(len(h.hint_list('barro', '02101')) == 1)
    assert(len(h.hint_list('raros', '22020')) == 1)
    assert(len(h.hint_list('racor', '22020')) == 1)
